# [Potential lost logger changes due to weak reference in OpenJDK](https://spotbugs.readthedocs.io/en/latest/bugDescriptions.html#LG_LOST_LOGGER_DUE_TO_WEAK_REFERENCE)
