# [A volatile reference to an array doesn't treat the array elements as volatile](https://spotbugs.readthedocs.io/en/latest/bugDescriptions.html#VO_VOLATILE_REFERENCE_TO_ARRAY)
