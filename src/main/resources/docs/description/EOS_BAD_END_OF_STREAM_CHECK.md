# [Data read is converted before comparison to -1](https://spotbugs.readthedocs.io/en/latest/bugDescriptions.html#EOS_BAD_END_OF_STREAM_CHECK)
      ...
      See SEI CERT rule [FIO08-J. Distinguish between characters or bytes read from a stream and -1](https://cmu-sei.github.io/secure-coding-standards/sei-cert-oracle-coding-standard-for-java/rules/input-output-fio/fio08-j/).