# [Switch statement found where one case falls through to the next case](https://spotbugs.readthedocs.io/en/latest/bugDescriptions.html#SF_SWITCH_FALLTHROUGH)
