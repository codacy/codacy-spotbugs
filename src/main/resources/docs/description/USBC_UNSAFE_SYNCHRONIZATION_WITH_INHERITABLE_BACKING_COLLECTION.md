# [Do not synchronize on a collection view, when the backing collection is made accessible through class extension](https://spotbugs.readthedocs.io/en/latest/bugDescriptions.html#USBC_UNSAFE_SYNCHRONIZATION_WITH_INHERITABLE_BACKING_COLLECTION)

      Synchronizing a collection view with a backing collection that is visible outside classes or subclass,
      might lead to nondeterministic behavior.
